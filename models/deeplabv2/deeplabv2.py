...
def get_deeplab_v2(num_classes=19, pretrain=True, pretrain_model_path='/content/semantic_segmentation-25/models/deeplabv2/DeepLab_resnet_pretrained_imagenet.pth'):
